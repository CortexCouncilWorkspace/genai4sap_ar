...
function qr(r) {
    ...
    return {
        c() {
            ...
            Conectado</p></div> <div class="p-4 border-t border-gray-200 dark:border-gray-700"><a class="flex justify-between items-center gap-x-3 py-2 px-3 text-sm text-slate-700 rounded-md hover:bg-gray-100 dark:hover:bg-gray-900 dark:text-slate-400 dark:hover:text-slate-300" href="#replace">Desconectar
...
function Mr(r) {
    ...
    return {
        c() {
            ...
            e = E("div"), e.innerHTML = '<img class="w-125 h-auto" src="header.png" alt="Company Logo"/>'//, v(e, "class", "max-w-4xl px-4 sm:px-6 lg:px-8 mx-auto text-center")
        },
        m(n, t) {
            U(n, e, t)
        },
...
function zr(r) {
    ...
    return {
        c() {
            e = E("div"), n = E("input"), t = Z(), o = E("div"), i = E("div"), s = E("div"), s.innerHTML = "", l = Z(), c = E("div"), a = E("button"), a.innerHTML = '<svg class="h-3.5 w-3.5" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16"><path d="M15.964.686a.5.5 0 0 0-.65-.65L.767 5.855H.766l-.452.18a.5.5 0 0 0-.082.887l.41.26.001.002 4.995 3.178 3.178 4.995.002.002.26.41a.5.5 0 0 0 .886-.083l6-15Zm-1.833 1.89L6.637 10.07l-.215-.338a.5.5 0 0 0-.154-.154l-.338-.215 7.494-7.494 1.178-.471-.47 1.178Z"></path></svg>', v(n, "type", "text"), v(n, "class", "p-4 pb-12 block w-full bg-gray-100 border-gray-200 rounded-md text-sm focus:border-blue-500 focus:ring-blue-500 dark:bg-slate-800 dark:border-gray-700 dark:text-gray-400"), v(n, "placeholder", "Haga una pregunta sobre sus datos para que pueda convertirlos en SQL"), v(s, "class", "flex items-center"), v(a, "type", "button"), v(a, "class", "inline-flex flex-shrink-0 justify-center items-center h-8 w-8 rounded-md text-white bg-blue-600 hover:bg-blue-500 focus:z-10 focus:outline-none focus:ring-2 focus:ring-blue-500 transition-all"), v(c, "class", "flex items-center gap-x-1"), v(i, "class", "flex justify-between items-center"), v(o, "class", "absolute bottom-px inset-x-px p-2 rounded-b-md bg-gray-100 dark:bg-slate-800"), v(e, "class", "relative")
        },
        m(k, x) {
...
function ii(r, e, n) {
    let {
        ...
        name: "DDL",
        description: "Estas son las declaraciones CREATE TABLE que definen la estructura de su base de datos.",
        example: "CREATE TABLE table_name (column_1 datatype, column_2 datatype, column_3 datatype);"
    }, {
        name: "Documentación",
        description: "Puede ser cualquier documentación basada en texto. Mantenga las piezas pequeñas y centradas en un solo tema.",
        example: "Nossa definição de ABC é XYZ."
    }, {
        name: "SQL",
        description: "Puede ser cualquier declaración SQL que funcione. Cuanto más, mejor.",
...
function fi(r) {
    ...
    return {
        c() {
            Te && Te.c(), e = Z(), n = E("div"), t = E("div"), o = E("div"), i = E("div"), s = E("div"), l = E("div"), c = E("div"), c.innerHTML = '<h2 class="text-xl font-semibold text-gray-800 dark:text-gray-200">Datos de entrenamiento</h2> <p class="text-sm text-gray-600 dark:text-gray-400">Añade o elimina datos de entrenamiento. Buenos datos de entrenamiento son la clave para la precisión.</p>', a = Z(), d = E("div"), g = E("div"), k = E("button"), k.textContent = "Ver todo", x = Z(), D = E("button"), D.innerHTML = `<svg class="w-3 h-3" xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none"><path d="M2.63452 7.50001L13.6345 7.5M8.13452 13V2" stroke="currentColor" stroke-width="2" stroke-linecap="round"></path></svg>
                    Agregar datos de entrenamiento`, L = Z(), m = E("table"), h = E("thead"), p = E("tr");
